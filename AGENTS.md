...
- **XKB unipunct layout** — DEFERRED: custom Russian layout research moved to `docs/research/xkb-unipunct-layout/`. CapsLock toggle + custom layout deployment are separate from bootstrap. Kitty `ru-shortcuts.conf` (Ctrl→Latin) remains in stow.
