...
Also installs custom keyboard layout `ruu` (via early stow, not system files) and GNOME keybindings.

### Early Dotfiles Stow (Step 1b)

Applies stow packages (zsh, kitty, opencode, nvim, tmux, xkb) early so later modules can find config files in place.
